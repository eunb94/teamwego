...
hotelMainVue = {
		hmain_body: x=>{
			...
			'</div>'+
			'</section>'+
			'		<div class="calendar-container" style="font-size: 20px;"><span class="time-tab"><label class="in"></label><input type="date" placeholder="Check in"> / <input type="date" placeholder="check-out"><a href="#" class="genric-btn primary radius">Search</a></span></div>'+
